...
from .utils import serverResponse, find_and_return_one, send_audit_email

def addAuditEmailEndpoints(app, mongo):
    def validate_audit_info_email(auditID):
        data = {}
        data["missing"] = []
        data["error"] = []
    ...
    def export_excel_to_email(auditID):  
        ...
        if validate:  
            ...
            sent = send_audit_email(app, to_email, subject, message,
